    ...
    <>
		<div className={classes.appbar}>
	             <div className={classes.ops}>
							...
							{getlocal("category") != null ?<Chip label={getlocal("category")} variant='outlined' className={classes.filterchip} style={{borderColor:CLR_HEAD  }}  deleteIcon={<MdClear size={30} /> } onDelete={(event)=>{ event.tar }}  onClick={() => { setCategoryfilter(true); } } />:<Chip label="Category" variant='outlined' className={classes.filterchip} style={{borderColor:"lightgrey",fontWeight: "200"  }}  deleteIcon={<MdClear size={30} /> } onClick={() => { setCategoryfilter(true); } } /> }
