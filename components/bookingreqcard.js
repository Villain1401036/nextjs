	...
	return(
      ...
      <div style={{padding:2+"vw"}}>
              ...
              {/* {status < 2? 
                ...
                {status == "3" && <><Button disabled className={classes.returnbutt} style={{color:"white",backgroundColor:"green", opacity:20+"%"}} onClick={()=>{ }}>confirmed</Button><Button className={classes.returnbutt} style={{borderColor:"orange", backgroundColor:"orange" , color:"white" , opacity:20+"%"}} disabled  onClick={() => props.Verifypickup(props.bookingobj.bookingKey, props.bookingobj)}>Picked up</Button> <Button className={classes.returnbutt} style={{borderColor:"purple"}} onClick={() => props.Verifyreturn(props.booking_id, props.bookingobj)}>Verify Return</Button> </>}
                {status == "4" && <><Button disabled className={classes.returnbutt} style={{color:"white",backgroundColor:"green", opacity:20+"%"}} onClick={()=>{ }}>confirmed</Button><Button className={classes.returnbutt} style={{borderColor:"orange", backgroundColor:"orange" , color:"white" , opacity:20+"%"}} disabled  onClick={() => props.Verifypickup(props.bookingobj.bookingKey, props.bookingobj)}>Picked up</Button> <Button className={classes.returnbutt} style={{borderColor:"purple"  , backgroundColor:"purple",color:"white" , opacity:20+"%" }} onClick={() => props.Verifyreturn(props.booking_id, props.bookingobj)} disabled>Returned</Button> </>}
                </div>
            </Card>
